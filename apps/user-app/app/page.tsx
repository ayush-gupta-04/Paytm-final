      ...
      <RootLayout>
        ...
        <div className="bg-[#f5f7fa] h-[770px] overflow-auto" style={{scrollbarWidth :"thin"}}>
          ...
          <div className="h-screen w-full flex flex-col justify-center items-center gap-8 font-bold">
            ...
            <div className="size-2/3"><img src="./landing3.png" className ="rounded-lg" alt="" /></div>
          </div>
          <div className="h-fit bg-white py-20 w-full flex flex-col justify-center items-center gap-8 font-bold">
            <div className="text-5xl">Business services by Paytm</div>
            <div className="size-2/3"><img src="./landing1.png" className ="rounded-lg" alt="" /></div>
            <div className="size-2/3"><img src="./landing2.png" className ="rounded-lg" alt="" /></div>
          </div>
          <div className="h-1/3 w-full gr-gray-300 flex flex-col py-10 px-10">
              <div className="flex flex-row">
                <div className="flex flex-col gap-2">
                  <div className="text-2xl font-bold">Paytm</div>
                  <div className="w-1/3">Paytm application is a project made by Ayush Gupta, which will serve some features like sending money to a UPI id , phone number, Adding money to the wallet , and withdrawing money from the wallet.</div>
                </div>
